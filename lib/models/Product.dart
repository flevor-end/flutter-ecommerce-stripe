...
class Product extends Model {
  ...
  static const String IMAGESCOLOR_KEY = "imagesColor";
  ...
  static const String USERS_PRODUCT = "users";
  ...
  factory Product.fromMap(Map<String, dynamic> map, {String id}) {
    ...
    return Product(
      ...
      imagesColor: map[IMAGESCOLOR_KEY].cast<String>(),
  ...
  Map<String, dynamic> toUpdateMap() {
    ...
    if (imagesColor != null) map[IMAGESCOLOR_KEY] = imagesColor;
    ...
    if (users != null) map[USERS_PRODUCT] = users;
