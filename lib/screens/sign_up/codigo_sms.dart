...
class Codigosms  extends  StatefulWidget{
  static String routeName = 'codigosms';
  Codigosms({Key key ,this.numero}) : super(key: key);

  final String numero;
     @override
  CodigosmsState createState() =>  CodigosmsState();
}

class  CodigosmsState extends State <Codigosms> {
  ...
  @override
   ...
   void initState() {
    super.initState();
     ...
     loginUser(widget.numero,context);
    ...
    _auth.verifyPhoneNumber(
        ...
        User user = result.user;
          if(user != null){
             ...
             Navigator.of(context).pushReplacementNamed(RegistroExitoso.routeName);
          }else{
            print("Error");
          }
        },
            ...
            builder: (context) {
              ...
              return   Dialog(
               ...
               child:
                ...
                children: <Widget>[
                  Text("NUMERO DE TELEFONO NO PUDO SER VERIFICADO\n\n INGRESE NUMERO VALIDO:",style: TextStyle(fontSize: 20,fontWeight:FontWeight.bold ),textAlign:TextAlign.center,),
                    SizedBox(height: 20,),
                    Padding(
        ...
        codeSent: (String verificationId, int resendToken){
          showDialog(
            ...
            Column(
          children: [
         Text("INGRESE CODIGO ENVIADO POR MENSAJE DE TEXTO AL NUMERO TERMINADO EN ${widget.numero.substring(9)}",style: TextStyle(fontSize: 20,fontWeight:FontWeight.bold ),textAlign:TextAlign.center,),
         SizedBox(height: 30,),
         Form(
