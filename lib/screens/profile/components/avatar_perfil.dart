...
class AvatarP extends StatefulWidget {
  ...
  final double tamano;
  @override
  _AvatarPEstate createState() => new _AvatarPEstate();
  
}

class _AvatarPEstate extends State<AvatarP> {
  ...
  Widget celador() {
    return StreamBuilder(
      ...
      builder: (BuildContext context, AsyncSnapshot snapshot) {   
        if (snapshot.hasData) {
          return CircleAvatar(
          onBackgroundImageError: (_, __) {Navigator.of(context).pushReplacementNamed(Transicion.routeName);},
