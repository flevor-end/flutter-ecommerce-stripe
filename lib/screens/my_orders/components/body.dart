          ...
          if (orderedProductsIds.length == 0) {
            return Center(
              child: NothingToShowContainer(
                ...
                secondaryMessage: "Pide algo para mostrar aquí",
              ),
            );
          }
                    ...
                    onPressed: () async {
                      ...
                      if (result is Review) {
                        ...
                        try {
                          ...
                          if (reviewAdded == true) {
                            snackbarMessage =
                                "Revisión de producto agregada correctamente";
                          } else {
                            throw "No se pudo agregar una reseña del producto debido a una razón desconocida";
                          }
                        } on FirebaseException catch (e) {
                          Logger().w("Firebase Exception: $e");
