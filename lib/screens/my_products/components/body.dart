...
import 'package:masdamas/services/data_streams/users_products_stream.dart';
            ...
            child: SizedBox(
              ...
              child: Column(
                children: [
                  ...
                  Text("Tus Productos", style: headingStyle),
                  Text(
                    "Desliza hacia la IZQUIERDA para editar, desliza hacia la DERECHA para eliminar",
                          ...
                          if (productsIds.length == 0) {
                            return Center(
                              child: NothingToShowContainer(
                                secondaryMessage:
                                    "Agregue su primer producto para vender",
                              ),
                            );
                          }
      ...
      confirmDismiss: (direction) async {
        if (direction == DismissDirection.startToEnd) {
          final confirmation = await showConfirmationDialog(
              context, "Estás segura de eliminar el producto?");
          if (confirmation) {
              ...
              await showDialog(
                ...
                builder: (context) {
                  return FutureProgressDialog(
                    deletionFuture,
                    message: Text(
                        "Eliminando Images de Producto ${i + 1}/${product.images.length}"),
                  );
                },
              );
            }
            ...
            try {
              ...
              productInfoDeleted = await showDialog(
                ...
                builder: (context) {
                  return FutureProgressDialog(
                    deleteProductFuture,
                    message: Text("Eliminando Producto"),
                  );
                },
              );
              if (productInfoDeleted == true) {
                snackbarMessage = "Producto eliminado correctamente";
              } else {
                throw "No se pudo eliminar el producto, vuelva a intentarlo";
              }
          ...
          final confirmation = await showConfirmationDialog(
              context, "Estás segura de editar el producto?");
          if (confirmation) {
