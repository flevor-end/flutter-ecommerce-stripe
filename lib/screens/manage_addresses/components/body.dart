...
import 'package:masdamas/screens/edit_address/edit_address_screen.dart';
import 'package:masdamas/screens/manage_addresses/components/address_short_details_card.dart';
import 'package:masdamas/services/data_streams/addresses_stream.dart';
            ...
            child: SizedBox(
              ...
              child: Column(
                children: [
                  ...
                  Text(
                    "Deslice el dedo hacia la IZQUIERDA para editar y hacia la DERECHA para eliminar",
                          ...
                          if (addresses.length == 0) {
                            return Center(
                              child: NothingToShowContainer(
                                ...
                                secondaryMessage: "Agrega tu Primera Dirección",
                              ),
                            );
                          }
