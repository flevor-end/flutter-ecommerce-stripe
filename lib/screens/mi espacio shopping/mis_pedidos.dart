...
class MiPedidos extends StatefulWidget {
   MiPedidos({Key key}) : super(key: key);

  @override
  _MiPedidosState createState() => _MiPedidosState();
}

class _MiPedidosState extends State<MiPedidos> {
  ...
  Widget build(BuildContext context) {
    ...
    child: Scaffold(
     ...
     Column(children: [
      ...
      SizedBox(width:78),
 Text("MIS PEDIDOS",style:TextStyle(color:kSecondaryColor,fontSize: 17,fontWeight:FontWeight.w600 ))
],),),
),
SizedBox(height: 8),
Expanded(
