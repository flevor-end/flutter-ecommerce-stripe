...
class ErrorP extends StatefulWidget {
   ErrorP({Key key}) : super(key: key);

  @override
  _ErrorPState createState() => _ErrorPState();
}

class _ErrorPState extends State<ErrorP> {
 ...
 SizedBox(width:16),
 Text("ERROR EN PAGO",style:TextStyle(color:kSecondaryColor,fontSize: 17,fontWeight:FontWeight.w600 ))
],),),
),
SizedBox(height: 20),
