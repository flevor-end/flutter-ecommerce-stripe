...
class DevolucioneC extends StatefulWidget {
   DevolucioneC({Key key}) : super(key: key);

  @override
  _DevolucioneCState createState() => _DevolucioneCState();
}

class _DevolucioneCState extends State<DevolucioneC> {
 ...
 SizedBox(width:16),
 Text("DEVOLUCION / CAMBIO",style:TextStyle(color:kSecondaryColor,fontSize: 17,fontWeight:FontWeight.w600 ))
],),),
),
SizedBox(height: 20),
