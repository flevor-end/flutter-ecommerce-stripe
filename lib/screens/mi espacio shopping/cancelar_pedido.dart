...
class CancelarP extends StatefulWidget {
  CancelarP({Key key}) : super(key: key);

  @override
  _CancelarPState createState() => _CancelarPState();
}

class _CancelarPState extends State<CancelarP> {
 ...
 SizedBox(width:16),
 Text("CANCELAR PEDIDO",style:TextStyle(color:kSecondaryColor,fontSize: 17,fontWeight:FontWeight.w600 ))
],),),
),
SizedBox(height: 20),
