...
class DevolucioneR extends StatefulWidget {
   DevolucioneR ({Key key}) : super(key: key);

  @override
  _DevolucioneRState createState() => _DevolucioneRState();
}

class _DevolucioneRState extends State<DevolucioneR> {
 ...
 SizedBox(width:16),
 Text("DEVOLUCION / REEMBOLSO",style:TextStyle(color:kSecondaryColor,fontSize: 17,fontWeight:FontWeight.w600 ))
],),),
),
SizedBox(height: 20),
