...
class PorDespachar extends StatefulWidget {
 PorDespachar({Key key}) : super(key: key);

  @override
  _PorDespacharState createState() => _PorDespacharState();
}

class _PorDespacharState extends State<PorDespachar> {
  ...
  Widget build(BuildContext context) {
    ...
    child: Scaffold(
     ...
     Column(children: [
      ...
      SizedBox(width:55),
 Text("POR DESPACHAR",style:TextStyle(color:kSecondaryColor,fontSize: 17,fontWeight:FontWeight.w600 ))
],),),
),
SizedBox(height:8,),
Expanded(
